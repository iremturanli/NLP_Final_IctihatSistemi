...
## Sunum İçin Tek-Slide Özeti

```
LegalRAG-TR — Sonuçlar
======================

📚  Veri: HuggingFace açık kaynak (700k Yargıtay+Danıştay), demo'da 2.000 karar
🧠  Fine-tune: e5-small × MNRL, 2.313 zayıf-denetimli çift, 33 sn (GPU fp16)
🔍  Retrieval: BM25 + dense + RRF (hibrit)

       Recall@1   MRR   nDCG@10   Latency
e5-small  0.733  0.833   0.836     22ms
e5-small+FT  0.933 ↑27%   0.933  0.887   15ms ↑daha hızlı
e5-base   0.800   0.833   0.811   17ms

✓ Fine-tune ilk doğru kararı %27 daha sık ilk sıraya getiriyor
✓ Daha küçük + fine-tuned model, daha büyük baseline'ı geçti
⚠ Reranker bu konfig'de yardımcı olmadı (future work: Türkçe-FT reranker)
```
